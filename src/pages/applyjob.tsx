...
const FileUploadZone: React.FC<FileUploadZoneProps> = ({ uploadedFile, onFileSelect }) => {
        ...
        <div className="w-full mt-5">
            ...
            <div
                className={`flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg transition duration-200 cursor-pointer 
                            ${isDragging ? 'border-indigo-600 bg-indigo-50' : 'border-gray-300 hover:border-indigo-400 hover:bg-gray-50'}`}
                ...
                {uploadedFile ? (
                    <div className="text-center w-full">
                        <p className="text-indigo-600 font-semibold flex items-center justify-center">
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618 4.618A9.955 9.955 0 0112 21.5c-4.419 0-8-3.582-8-8 0-1.748.599-3.397 1.632-4.747m0 0L4 11m4.368-4.368l-.893-.893M9 11l4 4m6.368 4.368l.893.893"></path></svg>
                            {uploadedFile.name} 
                        </p>
                        <p className="text-xs text-gray-500 mt-1">Size: {(uploadedFile.size / 1024 / 1024).toFixed(2)} MB</p>
                        <button 
                            type="button" 
                    ...
                    <div className="text-center">
                        <svg className="w-8 h-8 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
      ...
      <div className="w-full max-w-4xl">
        <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-10">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <section>
              <UiTextarea label="Information" placeholder='Explain why you are the right person for this job' isShadow/>
            </section>
            ...
            <div className="mt-10 pt-6 flex justify-end items-center">
                ...
                {submissionStatus === 'error' && (
                    <p className="text-red-600 font-semibold mr-4 flex items-center">
                         <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        Please upload your CV before submitting.
                    </p>
                )}

                <UiButton 
                   label="Submit Application" textClassName="text-white" 
                />
            </div>
          </form>
